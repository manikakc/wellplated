...
<body>
    <div class="conatiner">
        <div class="row">
            ...
            <p class="text-danger text-center fs-3 fw-bold my-3">Signup</p>
            <form action="insert.php" method="POST">
                ...
                <div class="mb-3">
                   <button name="submit" class="w-100 bg-danger fs-4">Sign up</button>
                </div>
                <div class="mb-3">
                   <button ><a href ="login.php" class = "text-decoration-none text-dark">Already have an account?</a></button>
                </div>
